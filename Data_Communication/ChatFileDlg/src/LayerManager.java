...
public class LayerManager { //Layer
	...
	private ArrayList<BaseLayer> mp_aLayers = new ArrayList<BaseLayer>() ;// Chatapp,socket,IPCDIG ì§ ùÑ    û•
	...
	public void ConnectLayers(String pcList){
		MakeList(pcList);
		LinkLayer(mp_sListHead); //mPList 
	}

	private void MakeList(String pcList){ // Layer   
